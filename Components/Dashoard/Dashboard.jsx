...
import { discordimageurl, apibaseurl } from "../../Service/constante";
...
function DashBoard({ guild_id }) {
    ...
    useEffect(() => {
        ...
        async function getData() {
            ...
            const request = await fetch(`${apibaseurl}/servers/${guild_id}`, requestOptions);
        ...
        <div className="main">
            {
                info.access ? 
                    <div className="dashboard">
                        <DashBoardNav setPage={setPage} guild={{icon: `${discordimageurl}/icons/${guild_id}/${info.to_send.guild.icon}.webp?size=128`, name: info.to_send.guild.name}} />
