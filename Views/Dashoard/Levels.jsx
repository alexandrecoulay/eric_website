...
function DashboardLevels({ guild_id, user }) {
    ...
    return (
        <ActivationContainer sendModification={sendChange} text="level" modification={modification} guild_id={guild_id} user={user} plugin="leveling">
