...
export const oauth2url = `${process.env.NEXT_PUBLIC_DISCORD_API_URL}/oauth2/authorize?client_id=${process.env.NEXT_PUBLIC_CLIENT_ID}&redirect_uri=${baseapiurl}/callback&response_type=code&scope=${process.env.NEXT_PUBLIC_SCOPES}`